...
(เลือกได้มากกว่า1ข้อ) : *</label> 
                                            ...
                                            <div class="card-body" style="border: 1px solid #dddddd; border-radius: 5 px;">
                                                <div class="form-check">
                                                    <input class="form-check-input unbox" type="checkbox" name="inredient" id="inredient1" value="สารสกัดจากผลไม้">
                                                    <label class="form-check-label" for="inredient1">สารสกัดจากผลไม้ </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input unbox" type="checkbox" name="inredient" id="inredient2" value="สารสกัดจากดอกไม้ ">
                                                    <label class="form-check-label" for="inredient2">สารสกัดจากดอกไม้  </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input unbox" type="checkbox" name="inredient" id="inredient3" value="สารสกัดจากสมุนไพร ">
                                                    <label class="form-check-label" for="inredient3">สารสกัดจากสมุนไพร  </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input unbox" type="checkbox" name="inredient" id="inredient4" value="สารสังเคราะห์ ">
                                            ...
                                            <div class="card-body" style="border: 1px solid #dddddd; border-radius: 5px;">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input unbox" type="checkbox" name="type_vitamin" id="type_vitamin1" value="แบบเม็ด/บรรจุกระปุก">
                                                    <label class="form-check-label" for="type_vitamin1">แบบเม็ด บรรจุกระปุก  </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input unbox" type="checkbox" name="type_vitamin" id="inlineCheckbox1" value="แบบผง บรรจุกระปุกชงดื่ม">
                                                    <label class="form-check-label" for="inlineCheckbox1">แบบผง บรรจุกระปุกชงดื่ม </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input unbox" type="checkbox" name="type_vitamin" id="inlineCheckbox1" value="แบบผง บรรจุซองฉีกซองรับประทาน">
                                                    <label class="form-check-label" for="inlineCheckbox1">แบบผง บรรจุซองฉีกซองรับประทาน </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input unbox" type="checkbox" name="type_vitamin" id="inlineCheckbox1" value="แบบขนม(เยลลี่/คาราจีแนน)บรรจุกล่อง">
                                                    <label class="form-check-label" for="inlineCheckbox1">แบบขนม(เยลลี่/คาราจีแนน)บรรจุกล่อง </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input unbox" type="checkbox" name="type_vitamin" id="inlineCheckbox1" value="แบบขนม(เยลลี่/คาราจีแนน)บรรจุกระปุก">
                                                    <label class="form-check-label" for="inlineCheckbox1">แบบขนม(เยลลี่/คาราจีแนน)บรรจุกระปุก </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input unbox" type="checkbox" name="type_vitamin" id="inlineCheckbox1" value="แบบเครื่องดื่ม/น้ำดื่มผสมวิตามิน">
                                            ...
                                            <div class="card-body" style="border: 1px solid #dddddd; border-radius: 5px;">
                                                <div class="form-check">
                                                    <div class="form-check"> 
                                                        <input class="form-check-input unbox" type="checkbox" name="amount" id="inlineCheckbox1" value="ต่ำกว่า 200 บาท">
                                                        <label class="form-check-label" for="inlineCheckbox1">ต่ำกว่า 200 บาท </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input unbox" type="checkbox" name="amount" id="inlineCheckbox1" value="201-500 บาท">
                                                        <label class="form-check-label" for="inlineCheckbox1">201-500 บาท </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input unbox" type="checkbox" name="amount" id="inlineCheckbox1" value="501-900 บาท">
                                                        <label class="form-check-label" for="inlineCheckbox1">501-900 บาท </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input unbox" type="checkbox" name="amount" id="inlineCheckbox1" value="901-1,000 บาท">
                                                        <label class="form-check-label" for="inlineCheckbox1">901-1,000 บาท </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input unbox" type="checkbox" name="amount" id="inlineCheckbox1" value="1,000 บาทขึ้นไป">
                                            ...
                                            <div class="card-body" style="border: 1px solid #dddddd; border-radius: 5px;">
                                                <div class="form-check">
                                                    <div class="form-check"> 
                                                        <input class="form-check-input unbox" type="checkbox" name="how_often" id="inlineCheckbox1" value="น้อยกว่า 1 เดือนต่อครั้ง">
                                                        <label class="form-check-label" for="inlineCheckbox1">น้อยกว่า 1 เดือนต่อครั้ง </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input unbox" type="checkbox" name="how_often" id="inlineCheckbox1" value="ประมาณ 1 – 3 เดือนต่อครั้ง">
                                                        <label class="form-check-label" for="inlineCheckbox1">ประมาณ 1 – 3 เดือนต่อครั้ง </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input unbox" type="checkbox" name="how_often" id="inlineCheckbox1" value="ประมาณ 4 –  6เดือนต่อครั้ง">
                                                        <label class="form-check-label" for="inlineCheckbox1">ประมาณ 4 –  6เดือนต่อครั้ง </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input unbox" type="checkbox" name="how_often" id="inlineCheckbox1" value="มากกว่า 6เดือนต่อครั้ง">
                                            ...
                                            <div class="card-body" style="border: 1px solid #dddddd; border-radius: 5px;">
                                                <div class="form-check">
                                                    <div class="form-check">
                                                        <input class="form-check-input unbox" type="checkbox" name="many_kind" id="inlineCheckbox1" value="น้อยกว่า 1 ชนิด">
                                                        <label class="form-check-label" for="inlineCheckbox1">น้อยกว่า 1 ชนิด </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input unbox" type="checkbox" name="many_kind" id="inlineCheckbox1" value="2-3 ชนิด">
                                                        <label class="form-check-label" for="inlineCheckbox1">2-3 ชนิด </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input unbox" type="checkbox" name="many_kind" id="inlineCheckbox1" value="4-6 ชนิด">
                                                        <label class="form-check-label" for="inlineCheckbox1">4-6 ชนิด </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input unbox" type="checkbox" name="many_kind" id="inlineCheckbox1" value="6 ชนิด ขึ้นไป">
                                            ...
                                            <div class="card-body" style="border: 1px solid #dddddd; border-radius: 5px;">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input unbox" name="other" id="other" value="other">
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input unbox" name="other_2" id="other_2" value="other">
                                                    <label for="other">Online (โปรดระบุแพลตฟอร์มที่ท่านรับชม)</label>
                                                    <input type="text" class="form-control hidden-other" name="information_vitamin[]" id="information_vitamin">
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input unbox" name="other_3" id="other_3" value="other">
                                                    <label for="other_3">Radio (โปรดระบุคลื่นวิทยุหรือรายการที่ท่านรับชม)</label>
                                                    <input type="text" class="form-control hidden-other" name="information_vitamin[]" id="information_vitamin">
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input unbox" name="other_4" id="other_4" value="other">
                                                    <label for="other_4">สื่อสิ่งพิมพ์ (โปรดระบุคอลัมน์ หรือ ชื่อสิ่งพิมพ์ที่ท่านรับชม)</label>
                                                    <input type="text" class="form-control hidden-other " name="information_vitamin[]" id="information_vitamin">
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input unbox" name="other_5" id="other_5" value="other">
                                                    <label for="other_5">สื่อกลางแจ้ง(โปรดระบุสื่อกลางแจ้งที่ท่านพบเช่น บิลบอร์ด,ป้ายโฆษณา,สติกเกอร์ติดรถ) </label>
                                                    <input type="text" class="form-control hidden-other" name="information_vitamin[]" id="information_vitamin">
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input unbox" name="other_6" id="other_6" value="other">
...
(เลือกได้มากกว่า1ข้อ): *</label>
                                            ...
                                            <div class="card-body" style="border: 1px solid #dddddd; border-radius: 5px;">
                                                <div class="form-check"> 
                                                        <div class="form-check">
                                                            <input class="form-check-input unbox" type="checkbox" name="influence" id="inlineCheckbox1" value="ตัวท่านเอง">
                                                            <label class="form-check-label" for="inlineCheckbox1">ตัวท่านเอง </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input unbox" type="checkbox" name="influence" id="inlineCheckbox1" value="เพื่อน / ครอบครัว / ที่ทำงาน">
                                                            <label class="form-check-label" for="inlineCheckbox1">เพื่อน / ครอบครัว / ที่ทำงาน </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input unbox" type="checkbox" name="influence" id="inlineCheckbox1" value="พรีเซนเตอร์ (superstar , celebrity)">
                                                            <label class="form-check-label" for="inlineCheckbox1">พรีเซนเตอร์ (superstar , celebrity) </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input unbox" type="checkbox" name="influence" id="inlineCheckbox1" value="อินฟูเอนเซอร์ (Net idol, Youtuber, Tiktoker)">
                                                            <label class="form-check-label" for="inlineCheckbox1">อินฟูเอนเซอร์ (Net idol, Youtuber, Tiktoker) </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input unbox" type="checkbox" name="influence" id="inlineCheckbox1" value="ผู้เชี่ยวชาญ นักวิชาการ ผู้ที่มีความน่าเชื่อถือ (Blogger)">
...
(เลือกได้มากกว่า1ข้อ): *</label>
                                            ...
                                            <div class="card-body" style="border: 1px solid #dddddd; border-radius: 5px;">
                                                <div class="form-check">
                                                    <div class="form-check">
                                                        <input class="form-check-input unbox" type="checkbox" name="promtion" id="inlineCheckbox1" value="การลดราคา ณ.จุดขาย">
                                                        <label class="form-check-label" for="inlineCheckbox1">การลดราคา ณ.จุดขาย </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input unbox" type="checkbox" name="promtion" id="inlineCheckbox1" value="การแจกสินค้าทดลองใช้ / สินค้าตัวอย่าง">
                                                        <label class="form-check-label" for="inlineCheckbox1">การแจกสินค้าทดลองใช้ / สินค้าตัวอย่าง </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input unbox" type="checkbox" name="promtion" id="inlineCheckbox1" value="การได้รับคูปองส่วนลด">
                                                        <label class="form-check-label" for="inlineCheckbox1">การได้รับคูปองส่วนลด </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input unbox" type="checkbox" name="promtion" id="inlineCheckbox1" value="การซื้อสินค้า 1แถม1 / 2แถม1">
                                                        <label class="form-check-label" for="inlineCheckbox1">การซื้อสินค้า 1แถม1 / 2แถม1 </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input unbox" type="checkbox" name="promtion" id="inlineCheckbox1" value="การส่งชิงโชค">
                                                        <label class="form-check-label" for="inlineCheckbox1">การส่งชิงโชค </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input unbox" type="checkbox" name="promtion" id="inlineCheckbox1" value="การสะสมแลกสินค้า">
...
(เลือกได้มากกว่า1ข้อ) : *</label>
                                            ...
                                            <div class="card-body" style="border: 1px solid #dddddd; border-radius: 5px;">
                                                <div class="form-check">
                                                    <div class="form-check">
                                                        <input class="form-check-input unbox" type="checkbox" name="inredient" id="inlineCheckbox1" value="สารสกัดจากผลไม้">
                                                        <label class="form-check-label" for="inlineCheckbox1">สารสกัดจากผลไม้ </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input unbox" type="checkbox" name="inredient" id="inlineCheckbox1" value="สารสกัดจากดอกไม้ ">
                                                        <label class="form-check-label" for="inlineCheckbox1">สารสกัดจากดอกไม้  </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input unbox" type="checkbox" name="inredient" id="inlineCheckbox1" value="สารสกัดจากสมุนไพร">
                                                        <label class="form-check-label" for="inlineCheckbox1">สารสกัดจากสมุนไพร </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input unbox" type="checkbox" name="inredient" id="inlineCheckbox1" value="สารสังเคราะห์">
                                            ...
                                            <div class="card-body" style="border: 1px solid #dddddd; border-radius: 5px;">
                                                <div class="form-check">
                                                    <div class="form-check">
                                                        <input class="form-check-input unbox" type="checkbox" name="type_vitamin" id="inlineCheckbox1" value="แบบเม็ด บรรจุกระปุก">
                                                        <label class="form-check-label" for="inlineCheckbox1">แบบเม็ด บรรจุกระปุก </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input unbox" type="checkbox" name="type_vitamin" id="inlineCheckbox1" value="แบบเม็ด บรรจุแผง">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input unbox" type="checkbox" name="type_vitamin" id="inlineCheckbox1" value="แแบบขนม(เยลลี่/คาราจีแนน)บรรจุกระปุก">
