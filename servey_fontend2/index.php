...
(เลือกได้มากกว่า1ข้อ) : *</label> 
                                            ...
                                            <div class="card-body" style="border: 1px solid #dddddd; border-radius: 5px;">
                                                <div class="form-check">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="TV (โปรดระบุช่องหรือรายการที่ท่านรับชม)">
                                                        <label class="form-check-label" for="inlineCheckbox1">TV (โปรดระบุช่องหรือรายการที่ท่านรับชม) </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="Online (โปรดระบุแพลตฟอร์มที่ท่านรับชม)">
                                                        <label class="form-check-label" for="inlineCheckbox1">Online (โปรดระบุแพลตฟอร์มที่ท่านรับชม) </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="Radio (โปรดระบุคลื่นวิทยุหรือรายการที่ท่านรับชม)">
                                                        <label class="form-check-label" for="inlineCheckbox1">Radio (โปรดระบุคลื่นวิทยุหรือรายการที่ท่านรับชม) </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="สื่อสิ่งพิมพ์ (โปรดระบุคอลัมน์ หรือ ชื่อสิ่งพิมพ์ที่ท่านรับชม)">
                                                        <label class="form-check-label" for="inlineCheckbox1">สื่อสิ่งพิมพ์ (โปรดระบุคอลัมน์ หรือ ชื่อสิ่งพิมพ์ที่ท่านรับชม) </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="สื่อกลางแจ้ง(โปรดระบุสื่อกลางแจ้งที่ท่านพบเช่น บิลบอร์ด,ป้ายโฆษณา,สติกเกอร์ติดรถ)">
...
(เลือกได้มากกว่า1ข้อ): *</label>
                                            <div class="card-body" style="border: 1px solid #dddddd; border-radius: 5px;">
                                                <div class="form-check">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="CVS(เช่น 7-11, Family mart,CJ Express)">
                                                        <label class="form-check-label" for="inlineCheckbox1">CVS(เช่น 7-11, Family mart,CJ Express) </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="Hyper (เช่น Big C, Tesco,Tops, Central Foodhall)">
                                                        <label class="form-check-label" for="inlineCheckbox1">Hyper (เช่น Big C, Tesco,Tops, Central Foodhall) </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ร้านขายยาชั้นนำ (เช่น Fascino,P&F,Save Drug,ตำรับไทย)">
                                                        <label class="form-check-label" for="inlineCheckbox1">ร้านขายยาชั้นนำ (เช่น Fascino,P&F,Save Drug,ตำรับไทย) </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ร้านขายยาทั่วไปใกล้บ้าน">
                                                        <label class="form-check-label" for="inlineCheckbox1">ร้านขายยาทั่วไปใกล้บ้าน </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ร้านสุขภาพและความงาม (เช่น Watsons,Boots,TSURUHA,eveandboy)">
                                                        <label class="form-check-label" for="inlineCheckbox1">ร้านสุขภาพและความงาม (เช่น Watsons,Boots,TSURUHA,eveandboy) </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="Shopping Online (เช่น Shopee, Lazada, JD Central)">
                                                        <label class="form-check-label" for="inlineCheckbox1">Shopping Online (เช่น Shopee, Lazada, JD Central) </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ช่องทางตรงกับบริษัท (เช่น ขายตรง,โทรสั่งกับบริษัท,สั่งกับเวปไซต์หรือFacebookของบริษัท)">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ช่องทางTV (เช่น TV Direct, True Select,O Shopping)">
                                            ...
                                            <div class="card-body" style="border: 1px solid #dddddd; border-radius: 5px;">
                                                <div class="form-check">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ตัวท่านเอง">
                                                            <label class="form-check-label" for="inlineCheckbox1">ตัวท่านเอง </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="เพื่อน / ครอบครัว / ที่ทำงาน">
                                                            <label class="form-check-label" for="inlineCheckbox1">เพื่อน / ครอบครัว / ที่ทำงาน </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="พรีเซนเตอร์ (superstar , celebrity)">
                                                            <label class="form-check-label" for="inlineCheckbox1">พรีเซนเตอร์ (superstar , celebrity) </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="อินฟูเอนเซอร์ (Net idol, Youtuber, Tiktoker)">
                                                            <label class="form-check-label" for="inlineCheckbox1">อินฟูเอนเซอร์ (Net idol, Youtuber, Tiktoker) </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ผู้เชี่ยวชาญ นักวิชาการ ผู้ที่มีความน่าเชื่อถือ (Blogger)">
...
(เลือกได้มากกว่า1ข้อ): *</label>
                                            ...
                                            <div class="card-body" style="border: 1px solid #dddddd; border-radius: 5px;">
                                                <div class="form-check">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="การลดราคา ณ.จุดขาย">
                                                        <label class="form-check-label" for="inlineCheckbox1">การลดราคา ณ.จุดขาย </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="การแจกสินค้าทดลองใช้ / สินค้าตัวอย่าง">
                                                        <label class="form-check-label" for="inlineCheckbox1">การแจกสินค้าทดลองใช้ / สินค้าตัวอย่าง </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="การได้รับคูปองส่วนลด">
                                                        <label class="form-check-label" for="inlineCheckbox1">การได้รับคูปองส่วนลด </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="การซื้อสินค้า 1แถม1 / 2แถม1">
                                                        <label class="form-check-label" for="inlineCheckbox1">การซื้อสินค้า 1แถม1 / 2แถม1 </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="การส่งชิงโชค">
                                                        <label class="form-check-label" for="inlineCheckbox1">การส่งชิงโชค </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="การสะสมแลกสินค้า">
...
(เลือกได้มากกว่า1ข้อ): *</label>
                                            <div class="card-body" style="border: 1px solid #dddddd; border-radius: 5px;">
                                                <div class="form-check">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="Facebook">
                                                        <label class="form-check-label" for="inlineCheckbox1">Facebook </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="Instagarm">
                                                        <label class="form-check-label" for="inlineCheckbox1">Instagarm </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="Line">
                                                        <label class="form-check-label" for="inlineCheckbox1">Line </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="Tiktok">
                                                        <label class="form-check-label" for="inlineCheckbox1">Tiktok </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="Twitter">
...
(เลือกได้มากกว่า1ข้อ): *</label>
                                            <div class="card-body" style="border: 1px solid #dddddd; border-radius: 5px;">
                                                <div class="form-check">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="รีวิวจาก Bloggers/รีวิวจาก Bloggers/Influencers (โปรดระบุBloggers/Influencersที่ท่านติดตาม)">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ค้นหาข้อมูลจาก Google">
                                                        <label class="form-check-label" for="inlineCheckbox1">ค้นหาข้อมูลจาก Google </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ค้นหาข้อมูลจากกระทู้ Pantip">
                                                        <label class="form-check-label" for="inlineCheckbox1">ค้นหาข้อมูลจากกระทู้ Pantip </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="สอบถามกับทางบริษัทผู้จัดจำหน่าย (โปรดระบุวิธีการสอบถามเช่น โทรศัพท์สอบถาม,สอบถามผ่านเวปไซต์)">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="หาข้อมูลสินค้าเพิ่มเติมที่เวปไซต์แบรนด์">
                                                        <label class="form-check-label" for="inlineCheckbox1">หาข้อมูลสินค้าเพิ่มเติมที่เวปไซต์แบรนด์ </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ถามพนักงานขาย ตัวแทน เภสัช">
                                                        <label class="form-check-label" for="inlineCheckbox1">ถามพนักงานขาย ตัวแทน เภสัช </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ถามเพื่อนหรือคนในครอบครัว">
...
(เลือกได้มากกว่า1ข้อ): *</label>
                                            <div class="card-body" style="border: 1px solid #dddddd; border-radius: 5px;">
                                                <div class="form-check">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ส่วนผสม และ แหล่งที่มาของวัตถุดิบ">
                                                        <label class="form-check-label" for="inlineCheckbox1">ส่วนผสม และ แหล่งที่มาของวัตถุดิบ </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="คุณภาพ มาตรฐานการผลิต">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="การประชาสัมพันธ์ / แนะนำ">
                                                        <label class="form-check-label" for="inlineCheckbox1">การประชาสัมพันธ์ / แนะนำ </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="สรรพคุณ/คุณประโยชน์ของผลิตภัณฑ์">
                                                        <label class="form-check-label" for="inlineCheckbox1">สรรพคุณ/คุณประโยชน์ของผลิตภัณฑ์ </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ราคา/โปรโมชั่น">
                                                        <label class="form-check-label" for="inlineCheckbox1">ราคา/โปรโมชั่น </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ตรายี่ห้อ">
                                                        <label class="form-check-label" for="inlineCheckbox1">ตรายี่ห้อ </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="บรรจุภัณฑ์">
                                            ...
                                            <input type="product" name="product" id="product" placeholder="โปรดระบุ"  class="form-control" />  <br>
...
(เลือกได้มากกว่า1ข้อ) : *</label>
                                            <div class="card-body" style="border: 1px solid #dddddd; border-radius: 5px;">
                                                <div class="form-check">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ราคาสูงไม่สอดคล้องกับคุณภาพ">
                                                        <label class="form-check-label" for="inlineCheckbox1">ราคาสูงไม่สอดคล้องกับคุณภาพ </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ยังไม่ถึงวัยที่ต้องการรับวิตามิน">
                                                        <label class="form-check-label" for="inlineCheckbox1">ยังไม่ถึงวัยที่ต้องการรับวิตามิน </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ไม่มีข้อมูลประกอบการตัดสินใจ">
                                                        <label class="form-check-label" for="inlineCheckbox1">ไม่มีข้อมูลประกอบการตัดสินใจ </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ไม่เห็นความจำเป็นในการรับประทานวิตามิน">
                                                        <label class="form-check-label" for="inlineCheckbox1">ไม่เห็นความจำเป็นในการรับประทานวิตามิน </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="คิดว่าบริโภคสินค้าทดแทน เช่น ผัก ผลไม้ ก็เพียงพอแล้ว">
                                                        <label class="form-check-label" for="inlineCheckbox1">คิดว่าบริโภคสินค้าทดแทน เช่น ผัก ผลไม้ ก็เพียงพอแล้ว </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ไม่พบแบรนด์ที่น่าสนใจ หรือ น่าเชื่อถือ">
                                                        <label class="form-check-label" for="inlineCheckbox1">ไม่พบแบรนด์ที่น่าสนใจ หรือ น่าเชื่อถือ </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="สิ้นเปลือง ">
...
(เลือกได้มากกว่า1ข้อ) : *</label>
                                            <div class="card-body" style="border: 1px solid #dddddd; border-radius: 5px;">
                                                <div class="form-check">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="วิตามินเอ Vitamin A">
                                                        <label class="form-check-label" for="inlineCheckbox1">วิตามินเอ Vitamin A </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="วิตามินบีรวม Vitamin B Complex">
                                                        <label class="form-check-label" for="inlineCheckbox1">วิตามินบีรวม Vitamin B Complex </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="วิตามินบี12 Vitamin B12">
                                                        <label class="form-check-label" for="inlineCheckbox1">วิตามินบี12 Vitamin B12 </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="วิตามินบี7 Vitamin B7">
                                                        <label class="form-check-label" for="inlineCheckbox1">วิตามินบี7 Vitamin B7 </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="วิตามินบี8 Vitamin B8">
                                                        <label class="form-check-label" for="inlineCheckbox1">วิตามินบี8 Vitamin B8 </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="วิตามินซี Vitamin C">
                                                        <label class="form-check-label" for="inlineCheckbox1">วิตามินซี Vitamin C </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="วิตามินดี Vitamin D">
                                                        <label class="form-check-label" for="inlineCheckbox1">วิตามินดี Vitamin D </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="วิตามินอี  Vitamin E">
                                                        <label class="form-check-label" for="inlineCheckbox1">วิตามินอี  Vitamin E </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="วิตามินรวม  Multi Vitamins">
                                                        <label class="form-check-label" for="inlineCheckbox1">วิตามินรวม  Multi Vitamins </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="แคลเซียม Calcium">
                                                        <label class="form-check-label" for="inlineCheckbox1">แคลเซียม Calcium </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ซิงค์ Zinc">
                                                        <label class="form-check-label" for="inlineCheckbox1">ซิงค์ Zinc </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="น้ำมันปลา Fish Oil">
                                                        <label class="form-check-label" for="inlineCheckbox1">น้ำมันปลา Fish Oil </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ไม่รู้จักเลย">
...
(เลือกได้มากกว่า1ข้อ) : *</label>
                                            <div class="card-body" style="border: 1px solid #dddddd; border-radius: 5px;">
                                                <div class="form-check">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ประสิทธิภาพด้านการมองเห็น">
                                                        <label class="form-check-label" for="inlineCheckbox1">ประสิทธิภาพด้านการมองเห็น </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="เสริมภูมิต้านทานให้ร่างกาย">
                                                        <label class="form-check-label" for="inlineCheckbox1">เสริมภูมิต้านทานให้ร่างกาย </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ช่วยชะลอความแก่และลดริ้วรอย">
                                                        <label class="form-check-label" for="inlineCheckbox1">ช่วยชะลอความแก่และลดริ้วรอย </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ลดความรุนแรงของไข้หวัด">
                                                        <label class="form-check-label" for="inlineCheckbox1">ลดความรุนแรงของไข้หวัด </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ช่วยชะลอหรือป้องกันโรคเกี่ยวกับกระดูก">
                                                        <label class="form-check-label" for="inlineCheckbox1">ช่วยชะลอหรือป้องกันโรคเกี่ยวกับกระดูก </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ช่วยในเรื่องระบบการขับถ่าย ">
                                                        <label class="form-check-label" for="inlineCheckbox1">ช่วยในเรื่องระบบการขับถ่าย  </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ช่วยลดความรู้สึกอ่อนล้า อ่อนเพลีย">
                                                        <label class="form-check-label" for="inlineCheckbox1">ช่วยลดความรู้สึกอ่อนล้า อ่อนเพลีย </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ความสามารถในการจดจำและการเรียนรู้ ">
                                                        <label class="form-check-label" for="inlineCheckbox1">ความสามารถในการจดจำและการเรียนรู้  </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ช่วยในการเผาผลาญ ไขมัน">
                                                        <label class="form-check-label" for="inlineCheckbox1">ช่วยในการเผาผลาญ ไขมัน </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="ช่วยควบคุมน้ำหนัก">
                                                        <label class="form-check-label" for="inlineCheckbox1">ช่วยควบคุมน้ำหนัก </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="บำรุงผิว/ผม/เล็บ ลดสิว">
                                                        <label class="form-check-label" for="inlineCheckbox1">บำรุงผิว/ผม/เล็บ ลดสิว </label>
                                                    </div>
                                                </div>
                                            </div> <br>
                                            ...
                                            <div class="card-body" style="border: 1px solid #dddddd; border-radius: 5px;">
                                                <div class="form-check">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="why[]" id="inlineCheckbox1" value="แแบบขนม(เยลลี่/คาราจีแนน)บรรจุกระปุก">
