                        ...
                        <fieldset>
                            <div class="form-card">
                                ...
                                <div class="row" style="border: 1px solid #dddddd; border-radius: 5px;">
                                    <input type="hidden" class="form-control" name="UID" id="UID" value="A10">
                                    <!-- UID -->
                                    ...
                                    <div class="col-12 br_pre">
                                        ...
                                        <div class="card-body" style="border: 1px solid #dddddd; border-radius: 5px;">
                                            ...
                                            <!-- used product -->
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" class="custom-control-input" name="status_inquiry[]" id="status_inquiry_non" value="ไม่เคย">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="card-body" style="border: 1px solid #dddddd; border-radius: 5px;">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <input class="form-check-input" type="radio" name="promtion[]" id="other_promotion" value="การสะสมแลกสินค้า">
                                                <label class="form-check-label" for="other_promotion">
                                                    อิ่นๆโปรดระบุ
                                                </label>
                                                <input type="text" class="form-control hidden-other" name="promtion[]" id="other_promotion">
                                            </div>
                                        </div>  <br>
                                        <!-- 13. -->
...
(เลือกได้มากกว่า1ข้อ) :</label>
                                            ...
                                            <input type="hidden" name="platform" id="platform" value="OTC">
                                        </div> 
                                    </div>  
                                </div>
                                <input type="submit" name="next" id="next"  class="next_sub action-button disabled" value="ยืนยัน" disabled="disabled" />  
